...
enclave "zeronym-shim-12" {
  ...
  network {
    ...
    http {
      domain = "zeronym-shim-12.shieldedinfra.net"
      port   = 8083
  ...
  unit "default" {
    ...
    env = {
      ...
      ZIS_HUB     = "35.154.23.202:443"
      ZIS_HUB_TLS = "zeronym-hub-8.shieldedinfra.net"
      ...
      #
      #   ZIS_TLS_DOMAIN = "zeronym-shim-12.shieldedinfra.net"
