...
enclave "zeronym-shim-10" {
  ...
  network {
    ...
    http {
      domain = "zeronym-shim-10.shieldedinfra.net"
      port   = 8083
  ...
  unit "default" {
    ...
    env = {
      ...
      ZIS_HUB     = "54.66.105.85:443"
      ZIS_HUB_TLS = "zeronym-hub-6.shieldedinfra.net"
      ...
      #
      #   ZIS_TLS_DOMAIN = "zeronym-shim-10.shieldedinfra.net"
