...
enclave "zeronym-shim-11" {
  ...
  network {
    ...
    http {
      domain = "zeronym-shim-11.shieldedinfra.net"
      port   = 8083
  ...
  unit "default" {
    ...
    env = {
      ...
      ZIS_HUB     = "15.175.61.224:443"
      ZIS_HUB_TLS = "zeronym-hub-7.shieldedinfra.net"
      ...
      #
      #   ZIS_TLS_DOMAIN = "zeronym-shim-11.shieldedinfra.net"
